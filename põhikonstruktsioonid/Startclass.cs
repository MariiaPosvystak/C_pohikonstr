...
namespace põhikonstruktsioonid
{
    internal class Startclass
    {
        public static void Main(string[] args)
        {
            ...
            string nimetus = Osa2_funktsioonid.Kuu_nimetus(kuu_number);
            ...
            else
            {
                try
                {
                    ...
                    Console.WriteLine(Osa2_funktsioonid.Hooaeg(kuu_number));
                }
                catch (Exception e)
                {
                    Console.WriteLine(e);
            ...
            else
            {
                try
                {
                    ...
                    string pilet = Osa2_funktsioonid.Pilet(vanus);
            ...
            try
            {
                ...
                Console.Write("Mis su nimi on? ");
                string nimi2 = Console.ReadLine();
                string con = Osa2_funktsioonid.Pärt(nimi1, nimi2, "");
            ...
            try
            {
                ...
                float pi = (Osa2_funktsioonid.Põrand(pikk, lai));
                ...
                else
                {
                    ...
                    Console.Write($"Su seina {pikk}x{lai} pindala = {pi} ");
                    float r = (Osa2_funktsioonid.Remont(m2hind, pi));
            ...
            try
            {
                ...
                float h = Osa2_funktsioonid.Thind(s_hind);
            ...
            try
            {
                ...
                string vast = Osa2_funktsioonid.Temperatuur(temp);
            ...
            try
            {
                ...
                string va = Osa2_funktsioonid.Pikkus(pikk);
            ...
            if (s.ToLower() == "mees")
            {
                string vast = Osa2_funktsioonid.P_mees(p);
                Console.WriteLine(vast);
            }
            else if (s.ToLower() == "naine")
            {
                string vast = Osa2_funktsioonid.P_naine(p);
                Console.WriteLine(vast);
            }
            else
            {
            ...
            if (t.ToLower() == "piim" || t.ToLower() == "piima")
            {
                ...
                if (t2.ToLower() != "ei")
                {
                    if (t2.ToLower() == "sai" || t2.ToLower() == "saia")
                    {
                        ...
                        if (t3.ToLower() != "ei")
                        {
                            if (t3.ToLower() == "leib" || t3.ToLower() == "leiba")
                            {
                                ...
                                float pls = Osa2_funktsioonid.Hind(k, k2, k3);
                        ...
                        {
                            float ps = Osa2_funktsioonid.Hind(k, k2, 0.0f);
                    ...
                    else if (t2.ToLower() == "leib" || t2.ToLower() == "leiba")
                    {
                        ...
                        {
                            float pl = Osa2_funktsioonid.Hind(k, 0.0f, k3);
                ...
                {
                    float p1 = Osa2_funktsioonid.Hind(k, 0.0f, 0.0f);
            ...
            else if (t.ToLower() == "sai" || t.ToLower() == "saia")
            {
                ...
                {
                    float s1 = Osa2_funktsioonid.Hind(0.0f, k2, 0.0f);
            ...
            else if (t.ToLower() == "leib" || t.ToLower() == "leiba")
            {
                ...
                {
                    float l1 = Osa2_funktsioonid.Hind(0.0f, 0.0f, k3);
            ...
            if (v.ToLower() == "jah")
            {
                ...
                Osa5_funktsioonid.Maakond_linnad(vastu, maakonnad);
